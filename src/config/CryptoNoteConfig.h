...
// Copyright (c) 2018, The SchoolCoin Project
// 
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1593110;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(509999999999999999);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(15300000000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff0001ffffffffffff0f029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210118d6ef6b614f75b71a8285c0964376ae62ac606aa59b38de95ac4d7ac7360b12";
...
const char     CRYPTONOTE_BLOCKS_FILENAME[]                  = "SchoolCoinblocks.bin";
const char     CRYPTONOTE_BLOCKINDEXES_FILENAME[]            = "SchoolCoinblockindexes.bin";
const char     CRYPTONOTE_POOLDATA_FILENAME[]                = "SchoolCoinpoolstate.bin";
const char     P2P_NET_DATA_FILENAME[]                       = "SchoolCoinp2pstate.bin";
...
const int      P2P_DEFAULT_PORT                              =  32463;
const int      RPC_DEFAULT_PORT                              =  32464;
...
{
    {  0x54, 0X48, 0X4f, 0X4d, 0X41, 0X53, 0X53, 0X47, 0X4f, 0X4f, 0X43, 0X4f, 0X49, 0X4e, 0X53, 0X0a  }
};

const char* const SEED_NODES[] = {
  "142.93.181.234:32463", //thomas groh1
  "138.68.7.40:32463"   //thomas groh2
};
} // CryptoNote
