...
- `git clone https://github.com/school-coin/SchoolCoin`
- `cd SchoolCoin`
- `mkdir build && cd $_`
- `cmake ..`
- `make`
...
- `git clone -b master https://github.com/school-coin/SchoolCoin`
- `cd SchoolCoin`
- `mkdir build && cd $_`
...
Run `./src/SchoolCoind` to connect to the network and let it sync (it may take a while).
...
#### Thanks
Cryptonote Developers, Bytecoin Developers, Monero Developers, Forknote Project, TurtleCoin Community, SchoolCoin Project
